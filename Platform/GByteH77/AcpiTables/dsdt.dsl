 ...
 * 
 * Disassembly of dsdt.bin, Mon Feb 13 13:06:47 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B3A4 (45988)
 *     Revision         0x02
 *     Checksum         0x97
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBA852C18, 0x027E)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xBA76CE18, 0x10)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xBA843018, 0x00E0)
                Field (GCAD, ByteAcc, NoLock, Preserve)
                {
                    XBUF,   1792
                }

                Name (XTMP, Buffer (0x00E0) {})
                Store (XBUF, XTMP)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xBA841018, 0x0000)
